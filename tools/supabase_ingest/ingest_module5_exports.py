...
from tools.supabase_ingest.mappers import map_module5_item


TARGET_TABLE = "module5_market_intelligence"
MODULE_NAME = "module5"
MANIFEST_FILE = "module5_manifest.json"
SCRIPT_NAME = "ingest_module5_exports.py"
...
MODULE5_FILE_MAP: dict[str, list[tuple[str, str]]] = {
    "uae": [
        ("module5_activity_feed.json", "activity_feed"),
        ("module5_agency_profiles.json", "agency_profiles"),
        ("module5_building_intelligence.json", "building_intelligence"),
        ("module5_community_intelligence.json", "community_intelligence"),
        ("module5_inventory_pressure.json", "inventory_pressure"),
        ("module5_market_dominance.json", "market_dominance"),
        ("module5_very_active_markets.json", "very_active_markets"),
        ("module5_summary.json", "summary"),
    ],
    "ksa": [
        ("module5_activity_agency.json", "activity_agency"),
        ("module5_activity_dominance.json", "activity_dominance"),
        ("module5_activity_pressure.json", "activity_pressure"),
        ("module5_activity_price_movements.json", "activity_price_movements"),
        ("module5_activity_priority.json", "activity_priority"),
        ("module5_activity_recently_detected.json", "activity_recently_detected"),
        ("module5_activity_recon.json", "activity_recon"),
        ("module5_agency_profiles_major.json", "agency_profiles_major"),
        ("module5_agency_profiles_micro.json", "agency_profiles_micro"),
        ("module5_city_intelligence.json", "city_intelligence"),
        ("module5_city_intelligence_major.json", "city_intelligence_major"),
        ("module5_district_intelligence.json", "district_intelligence"),
        ("module5_inventory_pressure_large.json", "inventory_pressure_large"),
        ("module5_inventory_pressure_small.json", "inventory_pressure_small"),
        ("module5_market_dominance_large.json", "market_dominance_large"),
        ("module5_market_dominance_small.json", "market_dominance_small"),
        ("module5_summary.json", "summary"),
    ],
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ingest dashboard-safe RASAD Module 5 frontend exports into Supabase."
    )
...
def run_module5_ingestion(
    ...
    print(
        f"Module 5 ingestion mode={'dry-run' if dry_run else 'write'} "
    ...
    try:
        for country in countries:
            ...
            for filename, view_key in MODULE5_FILE_MAP[country]:
    ...
    print(
        f"Module 5 summary: country={country_scope} dry_run={dry_run} "
