    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">Cross-portal CRE intelligence for offices, retail, warehouses, and land. PSF trends and absorption rates.</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-xl p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-1">
            <h2 className="text-base font-semibold text-white">Commercial Intel</h2>
            <p className="max-w-lg text-sm text-slate-400">Cross-portal CRE intelligence for offices, retail, warehouses, and land. PSF trends and absorption rates.</p>
          </div>
      ...
      <div className="rounded-2xl border border-amber-400/10 bg-amber-400/[0.04] backdrop-blur-xl p-5">
        ...
        <p className="mt-1 text-[13px] text-slate-400">
          We'll send you an in-dashboard alert the moment Commercial Intel goes live. No action needed.
        </p>
