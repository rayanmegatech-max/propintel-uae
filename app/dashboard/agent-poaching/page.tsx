  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-xl p-6">
      <div className="flex flex-wrap items-center gap-3">
        <h1 className="text-xl font-bold text-white">Agent Poaching Dossier</h1>
      ...
      <p className="mt-2 text-sm text-slate-400">Identify true top performers by deal velocity — not listing volume — for targeted recruitment.</p>
