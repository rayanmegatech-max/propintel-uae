  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-xl p-6">
        <h1 className="text-xl font-bold text-white">Agent Trust Score</h1>
        <p className="mt-1 text-sm text-slate-400">Verified deal-volume and performance data for yourself and every active UAE agent.</p>
      </div>
