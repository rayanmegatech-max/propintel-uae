  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-xl p-6">
        <h1 className="text-xl font-bold text-white">ReEstimate™</h1>
        <p className="mt-1 text-sm text-slate-400">AI-powered AVM that reconciles asking prices against live DLD transaction history.</p>
      </div>
