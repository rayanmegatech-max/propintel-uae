...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Agent Poaching", href: "/dashboard/agent-poaching", icon: Users },
  ...
  { label: "Agent Trust Score", href: "/dashboard/trust-score", icon: Shield, badge: { text: "New", variant: "count" } },
